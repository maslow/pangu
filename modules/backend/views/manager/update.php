...
/* @var $model \app\modules\backend\models\UpdateForm */

$this->title = Yii::t('backend', 'Update Manager');
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <?= Html::submitButton(Yii::t('backend', 'Update Manager'), ['class' => 'btn btn-primary', 'name' => 'update-manager']) ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
